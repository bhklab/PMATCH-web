        ...
        <div className="py-14 px-10 flex flex-col justify-center items-center" id="team">
            ...
            <div className="flex flex-row sm:flex-col gap-8 justify-center items-center text-center flex-wrap">
                {teams.map(team => (
                    <button
                        key={team.name}
                        className="flex flex-col px-10 py-10 md:px-6 md:py-6 shadow-lg gap-8 justify-between items-center border-solid border-1 rounded-lg w-[250px] h-[250px] transition duration-500 hover:scale-110 hover:cursor hover:border-red-1000 hover:shadow-red-1000"
            ...
            <div className="flex flex-row sm:flex-col gap-8 justify-center items-center text-center flex-wrap">
                {support.map(team => (
                    <a href={team.link} target="_blank" key={team.name}>
                        <div className="flex flex-col px-10 py-10 md:px-6 md:py-6 shadow-lg gap-8 justify-between items-center border-solid border-1 rounded-lg w-[250px] h-[250px] transition duration-500 hover:scale-110 hover:cursor hover:border-red-1000 hover:shadow-red-1000">
